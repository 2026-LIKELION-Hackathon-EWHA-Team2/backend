...
# 선택 설정: AI 호출 제한 시간(초)과 SDK 재시도 횟수
# OPENAI_TRANSLATION_TIMEOUT_SECONDS=30
# OPENAI_AGREEMENT_TIMEOUT_SECONDS=45
# OPENAI_MATCHING_TIMEOUT_SECONDS=30
# OPENAI_DOCUMENT_TIMEOUT_SECONDS=45
# OPENAI_MAX_RETRIES=1
# AI_REQUEST_LOCK_TIMEOUT_SECONDS=600
